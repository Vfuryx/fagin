...
var _ request.Request = AdminLoginLogList{}
...
func (r AdminLoginLogList) Validate(ctx *gin.Context) (any, map[string]string) {
	return request.Validate[AdminLoginLogList](r, ctx)
}
