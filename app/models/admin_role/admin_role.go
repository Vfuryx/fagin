...
type AdminRole struct {
	...
	Menus     []admin_menu.AdminMenu `gorm:"many2many:admin_role_menus;association_jointable_foreignkey:menu_id;jointable_foreignkey:role_id;association_autoupdate:false"`
}
