    ...
    >
      ...
      >
        <a-tab-pane key="tab1" :tab="$t('user.login.tab-login-credentials')">
          ...
          <a-form-item style="width: 70%;float: left;margin-bottom:0;">
            <a-input
              style="height: 49px;"
              size="large"
              type="text"
              :placeholder="$t('user.login.code')"
              v-decorator="[
                'code',
                {rules: [{ required: true, message: '验证码为空' } ], validateTrigger: 'change'}
              ]"
            >
          ...
          <div
            class="login-code"
            style=" width: 30%;height: 40px;float: right;background-color: darkgray;"
          >
            <img style="height: 40px;width: 100%;" :src="code_url" @click="getCode">
          </div>
